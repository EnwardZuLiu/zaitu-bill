        ...
        <nav>
            <ul class="pagination">
                <c:if test="${page.pagenow > 1}">
                    <li>
                        <a href="<%=request.getContextPath()%>/bill/bill/ceo/list/${page.pagenow - 1 }" aria-label="Previous">
                ...
                <c:if test="${page.pagenow > 2}">
                    <li>
                        <a href="<%=request.getContextPath()%>/bill/bill/ceo/list/${page.pagenow - 2 }">
                ...
                <c:if test="${page.pagenow > 1}">
                    <li>
                        <a href="<%=request.getContextPath()%>/bill/bill/ceo/list/${page.pagenow - 1 }">
                ...
                <c:if test="${page.pagenow != page.totalpage}">
                    <li>
                        <a href="<%=request.getContextPath()%>/bill/bill/ceo/list/${page.pagenow + 1 }" aria-label="Next">
